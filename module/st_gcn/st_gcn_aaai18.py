...
from module.st_gcn.ops import ConvTemporalGraphical, Graph
...
class ST_GCN_18(nn.Module):
    ...
    def __init__(self,
        ...
        # self.st_gcn_networks = nn.ModuleList([
        #     st_gcn_block(
        #         in_channels, 3, kernel_size, 1, residual=False, **kwargs0)]
        # )
        # layer_cfg = [
        #     ((3, 3, kernel_size, 1), kwargs),
        #     ((3, 3, kernel_size, 1), kwargs),
        #     ((3, 3, kernel_size, 1), kwargs),
        #     ((3, 3, kernel_size, 2), kwargs),
        #     ((3, 3, kernel_size, 1), kwargs),
        #     ((3, 3, kernel_size, 1), kwargs),
        #     ((3, 3, kernel_size, 2), kwargs),
        #     ((3, 3, kernel_size, 1), kwargs),
        ...
        #     ((64, 64, kernel_size, 1), kwargs),
        #     ((64, 64, kernel_size, 1), kwargs),
        #     ((64, 128, kernel_size, 1), kwargs),
        #     ((128, 128, kernel_size, 1), kwargs),
        #     ((128, 128, kernel_size, 1), kwargs),
        #     ((128, 256, kernel_size, 1), kwargs),
        #     ((256, 256, kernel_size, 1), kwargs),
        #     ((256, 256, kernel_size, 1), kwargs)
        # ]
    ...
    def forward(self, x):
        ...
        # prediction
        x = self.fcn(x) # b,256,256 -> b,512,256 扩充太多了
